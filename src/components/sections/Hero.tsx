...
export default function Hero() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-br from-[#FF8C2E] to-[#FF4F8B] pt-24 lg:pt-32 pb-0">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-8 relative z-20 pb-20 md:pb-28 lg:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pb-0">
